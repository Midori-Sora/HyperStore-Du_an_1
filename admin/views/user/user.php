                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <select name="role" class="form-control">
                                    ...
                                    <option value="1"
                                        <?= (isset($_GET['role']) && $_GET['role'] == '1') ? 'selected' : '' ?>>Admin
                                    </option>
                                    <option value="2"
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="status-badge <?= $user['status'] ? 'status-active' : 'status-inactive' ?>">
                                            <?= $user['status'] ? 'Hoạt động' : 'Ngừng hoạt động' ?>
                                        </span>
                                    </td>
                                    <td>
                                        <a href="index.php?action=viewUser&id=<?= htmlspecialchars($user['user_id']) ?>"
