    ...
    <div class="cart-container">
        ...
        <div class="cart-content">
                    ...
                    <div class="item-details">
                        ...
                        <div class="quantity-controls">
                            <button type="button" class="qty-btn minus"
                                data-id="<?php echo $item['pro_id']; ?>">-</button>
            ...
            <div class="cart-summary">
                ...
                <button type="button" class="checkout-btn" id="checkout-selected" disabled>
                    <i class="fas fa-lock"></i> Mua hàng (<span id="checkout-count">0</span>)
                </button>
                <a href="index.php?action=home" class="continue-shopping">
