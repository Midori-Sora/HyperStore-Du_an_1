            ...
            <div class="product-list">
                ...
                <div class="product-box">
                    <div class="product-image">
                        <img src="Uploads/Product/<?php echo $relatedProduct['thumbnail']; ?>"
                    ...
                    <div class="product-info">
                        ...
                        <div class="product-price">
                            <span
                                class="current-price"><?php echo number_format($relatedProduct['price'], 0, ',', '.'); ?>₫</span>
                            <?php if ($relatedProduct['original_price'] > $relatedProduct['price']): ?>
                            <span
                                class="original-price"><?php echo number_format($relatedProduct['original_price'], 0, ',', '.'); ?>₫</span>
                            <?php endif; ?>
                        </div>
